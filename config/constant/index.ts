...
// 应用名
export const APP_TITLE = "Vite-Vue3-Ts";

// 本地服务端口
export const VITE_PORT = 9527;
...
export const API_TARGET_URL = "http://localhost:9527";

// mock
export const MOCK_API_BASE_URL = "/mock/api";
export const MOCK_API_TARGET_URL = "http://localhost:9527";
